...
class Run(StoryChild):
    ...
    def footnotes(self):
        ...
        """
        return [
            FootnoteReference(footnoteReference, self)
            for footnoteReference in self._r.footnoteReference_lst
        ]
    ...
    def endnotes(self):
        ...
        """
        return [
            EndnoteReference(endnoteReference, self)
            for endnoteReference in self._r.endnoteReference_lst
        ]
